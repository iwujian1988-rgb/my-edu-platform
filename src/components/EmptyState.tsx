...
const EmptyState = () => (
  <div className="w-full h-64 border-[3px] border-black border-dashed rounded flex flex-col items-center justify-center gap-4 relative overflow-hidden group transition-colors duration-300"
    ...
    <Link href="/library">
      <button className="mt-2 px-6 py-2 bg-[#B4F416] border-2 border-black rounded font-black text-sm shadow-[2px_2px_0px_0px_#000] hover:translate-y-0.5 hover:shadow-none transition-all">
        去探索词库 →
      </button>
    </Link>
  </div>
